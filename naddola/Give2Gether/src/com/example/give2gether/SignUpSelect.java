...
public class SignUpSelect extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.signupselect);
	...
	public void onClick(View view) {
		...
		case R.id.signup_facebookButton:
			intent = new Intent(SignUpSelect.this,
					FacebookLoginActivity.class);
			startActivity(intent);
			break;
			
		case R.id.signup_googleButton:
			intent = new Intent(SignUpSelect.this, GoogleLoginActivity.class);
			startActivity(intent);
			break;
			
		case R.id.signup_Give2Gether:
			intent = new Intent(SignUpSelect.this, SignupGiv2gether.class);
			startActivity(intent);
			break;
